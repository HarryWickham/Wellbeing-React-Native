...
const Eula = () => (
  <ScrollView style={{ paddingHorizontal: 10 }}>
    ...
    <Text>
      This EULA agreement governs your acquisition and use of our Foobar
      software ("Software") directly from Foobar Inc. or indirectly through a
      Foobar Inc. authorized reseller or distributor (a "Reseller").
    </Text>
    <Text>
      Please read this EULA agreement carefully before completing the
      installation process and using the Foobar software. It provides a license
      to use the Foobar software and contains warranty information and liability
      disclaimers.
    </Text>
    <Text>
      If you register for a free trial of the Foobar software, this EULA
      agreement will also govern that trial. By clicking "accept" or installing
      and/or using the Foobar software, you are confirming your acceptance of
      the Software and agreeing to become bound by the terms of this EULA
      agreement.
    </Text>
    <Text>
    ...
    <Text>
      This EULA agreement shall apply only to the Software supplied by Foobar
      Inc. herewith regardless of whether other software is referred to or
      described herein. The terms also apply to any Foobar Inc. updates,
    ...
    <Text>
      • Use the Software for any purpose that Foobar Inc. considers is a breach
